...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2018 at 11:01 AM
...
INSERT INTO `customer_details` (`Customer_ID`, `Name`, `Company_name`, `Mobile_number`, `Email`, `Password`) VALUES
(1, 'Dhivakaran', 'D&P co', '9078563412', 'dp@gmail.com', 'dp'),
(2, 'Hari', 'hr co', '9087564312', 'hr@gmail.com', 'hr');
...
INSERT INTO `products` (`product_id`, `Product_name`, `Type_of_product`, `Price`, `number_of_products`) VALUES
(1, 't-shirt', 'shirt', '300', 989),
(2, 'Shorts', 'Lower', '250', 400);
